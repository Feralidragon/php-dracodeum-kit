...
/**
 * Call utility guard method options class.
 * 
 * @since 1.0.0
 ...
 * @property string|null $name [default = null] <p>The function or method name.<br>
 * If not set, the name of the current function or method in the stack is used.</p>
 * @property int $stack_offset [default = 0] <p>The stack offset.<br>
 * It must be greater than or equal to <code>0</code>.</p>
 * @property object|string|null $object_class [default = null] <p>The object or class.<br>
 * If not set, the object or class of the current function or method in the stack is used.</p>
 * @property array $parameters [default = []] <p>The parameters to replace the hint message placeholders with, 
 ...
 * <p>The text utility <code>Feralygon\Kit\Utilities\Text</code> stringification method options for the hint message, 
 ...
 * for a given hint message placeholder.<br>
 ...
 * The stringified value for the given hint message placeholder or <code>null</code> if no stringification occurred.
 * </p>
