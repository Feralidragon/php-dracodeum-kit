 ...
 * with the dump of object properties enabled, when the debug info, the <code>Feralygon\Kit\Traits\Readonly</code> 
 * and one of the following traits are used: <code>Feralygon\Kit\Traits\Properties</code> or 
