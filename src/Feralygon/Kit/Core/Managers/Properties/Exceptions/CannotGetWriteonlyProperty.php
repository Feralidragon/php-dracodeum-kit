 ...
 * 
 * This exception is thrown from a properties manager whenever a given write-only property with a given name 
...
class CannotGetWriteonlyProperty extends CannotGetProperty
{
	...
	{
		return "Cannot get write-only property {{name}} from properties manager with owner {{manager.getOwner()}}.";
	}
}
