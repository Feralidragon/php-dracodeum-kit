	...
	public function getDefaultMessage() : string
	{
		return "Class coercion failed with value {{value}}.\n" . 
			($this->isset('base_object_class')
				? "HINT: Only class strings and objects can be coerced into classes, and they must be or extend from {{base_object_class}}."
				: "HINT: Only class strings and objects can be coerced into classes."
			);
	}
