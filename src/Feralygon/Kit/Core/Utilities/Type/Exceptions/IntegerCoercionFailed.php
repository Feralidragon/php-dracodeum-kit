...
/**
 * Core type utility integer coercion failed exception class.
 * 
 ...
 */
class IntegerCoercionFailed extends Exception implements ICoercion
{
	...
	public function getDefaultMessage() : string
	{
		return "Integer coercion failed with value {{value}}.\n" . 
			"HINT: Only the following types and formats can be coerced into integers:\n" . 
			" - integers, such as: 123000 for 123000;\n" . 
			" - whole floats, such as: 123000.0 for 123000;\n" . 
			" - numeric strings, such as: \"123000\" for 123000;\n" . 
