...
class FloatCoercionFailed extends Exception implements ICoercion
{
	...
	public function getDefaultMessage() : string
	{
		return "Float coercion failed with value {{value}}.\n" . 
			"HINT: Only the following types and formats can be coerced into floats:\n" . 
			" - integers, such as: 123000 for 123000.0;\n" . 
			" - floats, such as: 123000.45 for 123000.45;\n" . 
			" - numeric strings, such as: \"123000.45\" or \"123000,45\" for 123000.45;\n" . 
			" - numeric strings in exponential notation, such as: \"123e3\" or \"123E3\" for 123000.0;\n" . 
			" - numeric strings in octal notation, such as: \"0360170\" for 123000.0;\n" . 
			" - numeric strings in hexadecimal notation, such as: \"0x1e078\" or \"0x1E078\" for 123000.0;\n" . 
			" - human-readable numeric strings, such as: \"123.45k\" or \"123.45 thousand\" for 123450.0;\n" . 
			" - human-readable numeric strings in bytes, such as: \"123.45kB\" or \"123.45 kilobytes\" for 123450.0.";
	}
