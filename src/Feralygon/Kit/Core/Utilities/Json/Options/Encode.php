 ...
 * as supported as <var>$options</var> by the PHP core <code>json_encode</code> function.</p>
 * @property int|null $depth [default = null] <p>The depth to use, 
 * as supported as <var>$depth</var> by the PHP core <code>json_encode</code> function.</p>
