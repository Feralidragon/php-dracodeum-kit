...
/**
 * Core text utility fill method invalid placeholder method identifier exception class.
 * 
 * This exception is thrown from the text utility fill method whenever a given placeholder method identifier is invalid.
 * 
 * @since 1.0.0
