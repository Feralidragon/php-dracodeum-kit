...
/**
 * Core text utility fill method placeholder key identifier not found exception class.
 * 
 * This exception is thrown from the text utility fill method whenever a given placeholder key identifier is not found.
 * 
 * @since 1.0.0
