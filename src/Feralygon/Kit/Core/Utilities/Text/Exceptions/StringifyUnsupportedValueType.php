...
/**
 * Core text utility stringify method unsupported value type exception class.
 * 
 * This exception is thrown from the text utility stringify method whenever a given value type is unsupported.
 * 
 * @since 1.0.0
