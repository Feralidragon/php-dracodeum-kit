...
/**
 * Core text utility indentate method invalid level exception class.
 * 
 * This exception is thrown from the text utility indentate method whenever a given level is invalid.
 * 
 * @since 1.0.0
