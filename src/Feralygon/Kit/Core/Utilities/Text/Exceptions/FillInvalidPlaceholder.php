...
/**
 * Core text utility fill method invalid placeholder exception class.
 * 
 * This exception is thrown from the text utility fill method whenever a given placeholder is invalid.
 * 
 * @since 1.0.0
