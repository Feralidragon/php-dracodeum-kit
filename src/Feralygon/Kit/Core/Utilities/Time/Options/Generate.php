 ...
 * 
 * @since 1.0.0
 * @property string|null $format [default = null] <p>The values format as supported by the PHP core <code>date</code> function.<br>
 * If not set, no format is used for the values, therefore only values in seconds will be returned.</p>
 * @property string|null $keys_format [default = null] <p>The keys format as supported by the PHP core <code>date</code> function.<br>
