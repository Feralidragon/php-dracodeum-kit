...
/**
 * Core time utility multiple coercion failed exception class.
 * 
 * This exception is thrown from the time utility whenever the coercion into a multiple has failed with a given value.
 * 
 * @since 1.0.0
 * @property-read mixed $value <p>The value.</p>
 * @property-read string|null $hint_message [default = null] <p>The hint message.</p>
 */
class MultipleCoercionFailed extends Exception implements ICoercion
{
	//Implemented public methods
	/** {@inheritdoc} */
	public function getDefaultMessage() : string
	{
		$message = "Multiple coercion failed with value {{value}}.";
