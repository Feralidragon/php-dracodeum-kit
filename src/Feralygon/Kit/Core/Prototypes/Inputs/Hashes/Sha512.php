...
/**
 * Core SHA-512 hash input prototype class.
 * 
 * This input prototype represents a SHA-512 hash, as a string in hexadecimal notation, in which only the following types of values are able to be evaluated as such:<br>
