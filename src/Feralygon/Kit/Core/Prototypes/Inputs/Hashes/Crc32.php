 ...
 * 
 * This input prototype represents a CRC32 hash, as a string in hexadecimal notation, in which only the following types of values are able to be evaluated as such:<br>
