 ...
 * 
 * This input constraint modifier prototype restricts a timestamp to a minimum value.
 * 
 * @since 1.0.0
...
class Minimum extends Constraint implements IPrototypeProperties, IName, IInformation, IStringification, ISpecificationData
{
	...
	public function getString(TextOptions $text_options) : string
	{
		...
		if ($this->exclusive) {
			/**
			 * @description Core timestamp input minimum constraint modifier prototype string (exclusive).
			 * @placeholder value The minimum allowed value.
			 * @tags core prototype input timestamp modifier constraint minimum string
			 * @example 2017-01-15 12:45:00 (exclusive)
			 */
			return UText::localize(
				"{{value}} (exclusive)", 
				'core.prototypes.inputs.timestamp.prototypes.modifiers.constraints.minimum', $text_options, [
