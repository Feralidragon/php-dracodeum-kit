...
class Values extends Constraint implements IPrototypeProperties, IName, IInformation, IStringification, ISpecificationData
{
	...
	public function getDescription(TextOptions $text_options) : string
	{
		...
		if ($this->negate) {
			/**
			 * @description Core date input values constraint modifier prototype description (negate).
			 * @placeholder values The list of disallowed date values.
			 * @tags core prototype input date modifier constraint values description
		...
		/**
		 * @description Core date input values constraint modifier prototype description.
	...
	public function getMessage(TextOptions $text_options) : ?string
	{
		...
		if ($this->negate) {
			 ...
			 * @example The given date cannot be 2017-01-15, 2017-01-17 nor 2017-01-18.
			 */
			return UText::localize(
				"The given date cannot be {{values}}.",
				'core.prototypes.inputs.date.prototypes.modifiers.constraints.values', $text_options, [
		 ...
		 * @placeholder values The list of allowed date values.
		 * @tags core prototype input date modifier constraint values message
		 * @example The given date must be 2017-01-15, 2017-01-17 or 2017-01-18.
		 */
		return UText::localize(
			"The given date must be {{values}}.",
			'core.prototypes.inputs.date.prototypes.modifiers.constraints.values', $text_options, [
				'parameters' => ['values' => UText::stringify($values_strings, $text_options, ['flags' => UText::STRING_NONASSOC_CONJUNCTION_OR | UText::STRING_NO_QUOTES])]
			]
		);
