 ...
 */
class MaxLength extends Constraint implements IPrototypeProperties, IName, IPriority, IInformation, IStringification, ISchemaData
{
	//Private properties
	/** @var int */
	private $length;
	...
	public function getMessage(TextOptions $text_options) : string
	{
		 ...
		 * @example Only values with a maximum of 10 characters are allowed.
		 */
		return UText::plocalize(
			"Only values with a maximum of {{length}} character are allowed.",
			"Only values with a maximum of {{length}} characters are allowed.",
