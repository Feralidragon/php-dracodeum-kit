...
/**
 * Core extended lazy properties trait cannot get write-once property exception class.
 * 
 * This exception is thrown from an object using the extended lazy properties trait whenever 
 * a given write-once property with a given name is attempted to be retrieved.
 * 
 * @since 1.0.0
 */
