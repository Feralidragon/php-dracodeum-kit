...
/**
 * Core extended lazy properties trait invalid boolean property value exception class.
 * 
 * This exception is thrown from an object using the extended lazy properties trait whenever a given value 
