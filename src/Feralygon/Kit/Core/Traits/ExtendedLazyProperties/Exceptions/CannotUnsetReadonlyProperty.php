...
/**
 * Core extended lazy properties trait cannot unset read-only property exception class.
 * 
 * This exception is thrown from an object using the extended lazy properties trait whenever a given read-only property 
