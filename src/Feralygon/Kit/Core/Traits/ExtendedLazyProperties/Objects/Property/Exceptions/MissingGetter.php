...
/**
 * Core extended lazy properties trait property object missing getter exception class.
 * 
 * This exception is thrown from an extended lazy properties trait property object whenever a getter function 
 * is missing.
 * 
 * @since 1.0.0
 */
