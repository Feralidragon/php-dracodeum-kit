...
use Feralygon\Kit\Core\Traits\ExtendedLazyProperties\Objects\Property\Exceptions as PropertyExceptions;
use Feralygon\Kit\Core\Utilities\Call as UCall;

/**
 * Core extended lazy properties trait.
 * 
 * This trait enables the support for a separate layer of custom extended lazy-loaded properties in a class.<br>
 ...
 * <br>
 * Each property may behave individually in a distinct manner, is only loaded on demand (lazy-loading), 
 ...
 * @since 1.0.0
 */
trait ExtendedLazyProperties
{
	//Private properties
	/** @var \Feralygon\Kit\Core\Traits\ExtendedLazyProperties\Objects\Property[] */
	private $properties = [];
	 ...
	 * @since 1.0.0
	 * @param string $name <p>The property name to get from.</p>
	 * @throws \Feralygon\Kit\Core\Traits\ExtendedLazyProperties\Exceptions\CannotGetWriteonlyProperty
	 * @throws \Feralygon\Kit\Core\Traits\ExtendedLazyProperties\Exceptions\CannotGetWriteonceProperty
	 * @throws \Feralygon\Kit\Core\Traits\ExtendedLazyProperties\Exceptions\PropertyNotInitialized
	 * @return mixed <p>The property value from the given name.</p>
	 */
	 ...
	 * @since 1.0.0
	 * @param string $name <p>The property name to get from.</p>
	 * @throws \Feralygon\Kit\Core\Traits\ExtendedLazyProperties\Exceptions\InvalidBooleanPropertyValue
	 ...
	 * @param string $name <p>The property name to set for.</p>
	 * @param mixed $value <p>The property value to set with.</p>
	 * @throws \Feralygon\Kit\Core\Traits\ExtendedLazyProperties\Exceptions\CannotSetReadonlyProperty
	 * @throws \Feralygon\Kit\Core\Traits\ExtendedLazyProperties\Exceptions\CannotSetWriteonceProperty
	 * @throws \Feralygon\Kit\Core\Traits\ExtendedLazyProperties\Exceptions\InvalidPropertyValue
	 ...
	 * @since 1.0.0
	 * @param string $name <p>The property name to unset from.</p>
	 * @throws \Feralygon\Kit\Core\Traits\ExtendedLazyProperties\Exceptions\CannotUnsetReadonlyProperty
	 * @throws \Feralygon\Kit\Core\Traits\ExtendedLazyProperties\Exceptions\CannotUnsetWriteonceProperty
	 * @throws \Feralygon\Kit\Core\Traits\ExtendedLazyProperties\Exceptions\CannotUnsetRequiredProperty
	 * @throws \Feralygon\Kit\Core\Traits\ExtendedLazyProperties\Exceptions\CannotUnsetProperty
	 * @return $this <p>This instance, for chaining purposes.</p>
	 */
	 ...
	 * 
	 * @since 1.0.0
	 * @return \Feralygon\Kit\Core\Traits\ExtendedLazyProperties\Objects\Property <p>The created property instance.</p>
	 */
	 ...
	 * <br>
	 * Return: <code><b>\Feralygon\Kit\Core\Traits\ExtendedLazyProperties\Objects\Property|null</b></code><br>
	 ...
	 * @throws \Feralygon\Kit\Core\Traits\ExtendedLazyProperties\Exceptions\PropertiesAlreadyInitialized
	 * @throws \Feralygon\Kit\Core\Traits\ExtendedLazyProperties\Exceptions\MissingRequiredProperties
	 * @throws \Feralygon\Kit\Core\Traits\ExtendedLazyProperties\Exceptions\InvalidPropertyValue
	 * @return void
	 */
	 ...
	 * @since 1.0.0
	 * @param string $name <p>The property name to get from.</p>
	 * @throws \Feralygon\Kit\Core\Traits\ExtendedLazyProperties\Exceptions\PropertiesNotInitialized
	 * @throws \Feralygon\Kit\Core\Traits\ExtendedLazyProperties\Exceptions\PropertyNotFound
	 * @return \Feralygon\Kit\Core\Traits\ExtendedLazyProperties\Objects\Property 
