...
/**
 * Core lazy properties trait cannot unset required property exception class.
 * 
 * This exception is thrown from an object using the lazy properties trait whenever a given required property 
