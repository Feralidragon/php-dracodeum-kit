...
namespace Feralygon\Kit\Core\Traits\ExtendedProperties\Objects;

use Feralygon\Kit\Core\Traits\ExtendedProperties\Objects\Property\Exceptions;
use Feralygon\Kit\Core\Traits\NoConstructor as TNoConstructor;
use Feralygon\Kit\Core\Utilities\Call as UCall;

/**
 * Core extended properties trait property object class.
 * 
 * @since 1.0.0
...
final class Property
{
	 ...
	 * 
	 * @since 1.0.0
	 * @throws \Feralygon\Kit\Core\Traits\ExtendedProperties\Objects\Property\Exceptions\MissingGetter
	 * @throws \Feralygon\Kit\Core\Traits\ExtendedProperties\Objects\Property\Exceptions\NotInitialized
	 ...
	 * @throws \Feralygon\Kit\Core\Traits\ExtendedProperties\Objects\Property\Exceptions\InvalidValue
	 * @throws \Feralygon\Kit\Core\Traits\ExtendedProperties\Objects\Property\Exceptions\MissingSetter
	 * @return $this <p>This instance, for chaining purposes.</p>
	 */
	 ...
	 * 
	 * @since 1.0.0
	 * @throws \Feralygon\Kit\Core\Traits\ExtendedProperties\Objects\Property\Exceptions\NoDefaultValueSet
	...
	{
		//set
		UCall::assertSignature($evaluator, function (&$value) : bool {}, true);
