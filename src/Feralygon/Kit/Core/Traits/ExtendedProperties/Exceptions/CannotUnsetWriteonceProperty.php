 ...
 * 
 * This exception is thrown from an object using the extended properties trait whenever a given write-once property with a given name is attempted to be unset.
 * 
 * @since 1.0.0
 */
