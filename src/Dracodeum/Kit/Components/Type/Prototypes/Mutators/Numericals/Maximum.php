...
/**
 * This prototype restricts a given numeric value to a maximum number.
 * 
 ...
 */
class Maximum extends Prototype implements IExplanationProducer
{
	...
	public function produceExplanation()
	{
		...
		return $this->exclusive
			? $text->setString("Must be less than {{number}}.")
			: $text->setString("Must be less than or equal to {{number}}.");
	}
