...
/** This prototype restricts a given numeric value to an odd number. */
class Odd extends Prototype implements IExplanationProducer
{
	...
	{
		return Text::build("Must be odd.")->setAsLocalized(self::class);
	}
}
