 ...
 * 
 * @property object|null $object [default = null]
 * <p>The object to use for placeholders without a corresponding parameter.</p>
...
class Fill extends Options
{
	...
	protected function buildProperty(string $name): ?Property
	{
		switch ($name) {
			case 'object':
				return $this->createProperty()->setAsStrictObject(null, true)->setDefaultValue(null);
			case 'string_options':
