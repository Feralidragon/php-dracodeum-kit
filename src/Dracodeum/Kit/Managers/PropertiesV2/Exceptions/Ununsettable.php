 ...
 * The scope class.
 */
class Ununsettable extends Exception
{
	...
	public function getDefaultMessage(): string
	{
		...
		$message = count($this->names) === 1
			? "The property {{names}} from {{manager.getOwner()}} is not unsettable"
			: "The properties {{names}} from {{manager.getOwner()}} are not unsettable";
