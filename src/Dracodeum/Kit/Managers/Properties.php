...
class Properties extends Manager implements IDebugInfo, IDebugInfoProcessor, IKeyable
{
	 ...
	 * <p>This instance, for chaining purposes.</p>
	 */
	final public function persist(callable $inserter, callable $updater, bool $changes_only = false): Properties
	{
		//assert
	 ...
	 * <p>The processed old property values, as a set of <samp>name => value</samp> pairs.</p>
	 * @param array $new_values [reference output] [default = []]
	 * <p>The processed new property values, as a set of <samp>name => value</samp> pairs.</p>
	 * @param array|null $names [default = null]
	 * <p>The property names to restrict the map to.</p>
	 * @return array
	 * <p>The persistence property changes map, as a set of <samp>name => <code>true</code></samp> pairs.</p>
	 */
