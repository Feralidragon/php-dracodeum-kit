...
use Dracodeum\Kit\Components\Type\Prototypes\Mutators\Stringable\LengthRange as Prototype;
use Dracodeum\Kit\Primitives\{
	Error,
	Text
};

/** @see \Dracodeum\Kit\Components\Type\Prototypes\Mutators\Stringable\LengthRange */
class LengthRangeTest extends TestCase
{
	...
	public function provideProcessData_Error(): array
	{
		return [
			...
			['Foo Bar', [1, 6]],
			['Foo Bar', [8, 15]],
			["foo\u{2003}b\u{01d4b6}r", [2, 11]],
			["foo\u{2003}b\u{01d4b6}r", [13, 20]],
			["foo\u{2003}b\u{01d4b6}r", [1, 6, 'unicode' => true]],
			["foo\u{2003}b\u{01d4b6}r", [8, 12, 'unicode' => true]]
		];
	}
